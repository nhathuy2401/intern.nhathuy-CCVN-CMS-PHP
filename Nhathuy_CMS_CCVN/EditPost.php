...
if (isset($_POST['submit'])) {
    ...
    if (empty($PostTitle)) {
        ...
        redirect_To('EditPost.php?id=$SearchQueryParams');
...
<section class="container py-2 mb-4">
    <div class="row">
        <div class="offset-lg-1 col-lg-10" style="min-height: 400px;">
            ...
            ?>
            <form action="EditPost.php?id=<?=$SearchQueryParams ?>" method="post" enctype="multipart/form-data">
                <div class="card bg-secondary text-light mb-3">
                    ...
                    <div class="card-body bg-dark">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="posts_title" id="title" value="<?= $TitleBeUpdate ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <br>
                            <label for="title">
                                <span class="FieldInfo">New  Category : </span>
